...
<head>
	...
	<meta name="description" content="Curso: Formação Java Web Full-Stack e Spring Boot REST API (JDEV Treinamento)" />
	<meta name="author" content="Aluno: Givaldo Medeiros Neto" />
	
	<!-- Favicon icon -->	
	<link rel="icon" href="<%= request.getContextPath() %>/assets/images/jsp.ico" type="image/x-icon">
